...
public class ContentModel {
    ...
    public final Translate cameraPosition = new Translate(0,0,0);
    public final Xform cameraXform = new Xform();
    public final Xform cameraXform2 = new Xform();
    ...
    private final EventHandler<MouseEvent> mouseEventHandler = event -> {
        ...
        if (event.getEventType() == MouseEvent.MOUSE_PRESSED) {
            ...
            if(event.isMiddleButtonDown() || (event.isPrimaryButtonDown() && event.isSecondaryButtonDown())) {
                ...
                datas.setTx(cameraXform2.t.getX() + xFlip*mouseDeltaX*modifierFactor*modifier*0.3);
                datas.setTy(cameraXform2.t.getY() + yFlip*mouseDeltaY*modifierFactor*modifier*0.3);
                datas.setOrder(1);
            }
                ...
                datas.setRy(cameraXform.ry.getAngle() - yFlip*mouseDeltaX*modifierFactor*modifier*2.0);
                datas.setRx(cameraXform.rx.getAngle() + xFlip*mouseDeltaY*modifierFactor*modifier*2.0);
                datas.setOrder(2);
            }
